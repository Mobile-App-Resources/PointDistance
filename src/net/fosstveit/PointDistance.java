package net.fosstveit;

import java.math.BigDecimal;
import net.fosstveit.R;
import net.fosstveit.interfaces.GPSCallback;
import net.fosstveit.managers.GPSManager;
...
public class PointDistance extends Activity implements GPSCallback {
	private final static double[] multipliers = { 1.0, 1.0936133, 0.001,
			0.000621371192 };

	private final static String[] unitstrings = { "m", "y", "km", "mi" };
	...
	private void startMeasuring() {
		...
		((TextView) findViewById(R.id.info))
				.setText(getString(R.string.measuring_info));
	...
	private void stopMeasuring() {
		...
		((TextView) findViewById(R.id.info))
				.setText(getString(R.string.start_measuring_info));
	...
	private void updateMeasurement() {
		double distance = calcGeoDistance(startLat, startLon, currentLat,
				currentLon)
				* multipliers[unitindex];
		String distanceText = "" + RoundDecimal(distance, 2) + " "
